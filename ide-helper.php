...
namespace Illuminate\Database\Eloquent {
    ...
    class Model
    {
        ...
        {
            return Builder::make($attributes);
        }
        ...
        {
            return Builder::withGlobalScope($identifier, $scope);
        }
        ...
        {
            return Builder::fromQuery($query, $bindings);
        }
        ...
        {
            return Builder::findOrNew($id, $columns);
        }
        ...
        {
            return Builder::firstOrNew($attributes, $values);
        }
        ...
        {
            return Builder::firstOr($columns, $callback);
        }
        ...
        {
            return Builder::eagerLoadRelations($models);
        }
        ...
        {
            return Builder::chunkById($count, $callback, $column, $alias);
        }
        ...
        {
            return Builder::forceCreate($attributes);
        }
        ...
        {
            return Builder::without($relations);
        }
        ...
        {
            return Builder::newModelInstance($attributes);
        }
        ...
        {
            return Builder::setEagerLoads($eagerLoad);
        }
        ...
        {
            return Builder::each($callback, $count);
        }
        ...
        {
            return Builder::when($value, $callback, $default);
        }
        ...
        {
            return Builder::unless($value, $callback, $default);
        }
        ...
        {
            return Builder::orHas($relation, $operator, $count);
        }
        ...
        {
            return Builder::doesntHave($relation, $boolean, $callback);
        }
        ...
        {
            return Builder::orDoesntHave($relation);
        }
        ...
        {
            return Builder::whereHas($relation, $callback, $operator, $count);
        }
        ...
        {
            return Builder::orWhereHas($relation, $callback, $operator, $count);
        }
        ...
        {
            return Builder::whereDoesntHave($relation, $callback);
        }
        ...
        {
            return Builder::orWhereDoesntHave($relation, $callback);
        }
        ...
        {
            return Builder::mergeConstraintsFrom($from);
        }
